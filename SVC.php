...
echo "Hasil Confusion Matrix Algoritma Support Vector Classification";
echo "<pre>";
...
<html>
  <head>
      <title>Prediksi Gaya Belajar dengan Support Vector Classification</title>
      <style>
          table {
...
if (!empty($_FILES['inputData'])) {
    ...
    echo "<hr><br>Hasil Klasifikasi Algoritma Support Vector Classification dari file yang telah diupload:";
