...
echo "Hasil Confusion Matrix Algoritma Bootstrap Aggregation";
echo "<pre>";
...
<html>
  <head>
      <title>Prediksi Gaya Belajar dengan Bootstrap Aggregation</title>
      <style>
          table {
...
if (!empty($_FILES['inputData'])) {
    ...
    echo "<hr><br>Hasil Klasifikasi Algoritma Bootstrap Aggregation dari file yang telah diupload:";
